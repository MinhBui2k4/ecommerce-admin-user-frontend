        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/products?category=laptop" className="text-sm text-gray-600 hover:text-red-600">
                  Laptop
                </Link>
              </li>
              <li>
                <Link to="/products?category=smartphone" className="text-sm text-gray-600 hover:text-red-600">
                  Điện thoại
                </Link>
              </li>
              <li>
                <Link to="/products?category=tablet" className="text-sm text-gray-600 hover:text-red-600">
                  Máy tính bảng
                </Link>
              </li>
              <li>
                <Link to="/products?category=accessories" className="text-sm text-gray-600 hover:text-red-600">
                  Phụ kiện
                </Link>
              </li>
              <li>
                <Link to="/products?category=smartwatch" className="text-sm text-gray-600 hover:text-red-600">
                  Đồng hồ thông minh
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/contact" className="text-sm text-gray-600 hover:text-red-600">
                  Liên hệ
                </Link>
              </li>
              <li>
                <Link to="/policy/privacy" className="text-sm text-gray-600 hover:text-red-600">
                  Chính sách bảo mật
                </Link>
              </li>
              <li>
                <Link to="/policy/terms" className="text-sm text-gray-600 hover:text-red-600">
                  Điều khoản sử dụng
                </Link>
              </li>
              <li>
                <Link to="/policy/return" className="text-sm text-gray-600 hover:text-red-600">
                  Chính sách đổi trả
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-2 flex">
                ...
                <Button
                  size="inputGroup"
                   className="rounded-l-none min-w-[80px] whitespace-nowrap"
                >
                  Đăng ký
                </Button>
